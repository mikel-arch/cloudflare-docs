-control + Shift + m to toggle the tab key moving focus.Alternatively,use esc then tab to moveto the next interactive element on the page--
pcx_content_type: how-to
title: Registrant contact updates

-mikel-arch/cloudfare-docs,--
